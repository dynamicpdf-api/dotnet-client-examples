...
namespace DynamicPdfCloudApiClientExamples
{
    ...
    class Program
    {
        ...
        // second argument is the base path to include final /
        ...
        static void Main(string[] args)
        {
            ...
            // DlexLayoutTutorial.DlexLayoutExampleOne(args[0], args[1]);
            // ImageInfoExampleTutorial.ImageInfoExampleOne(args[0], args[1]);
